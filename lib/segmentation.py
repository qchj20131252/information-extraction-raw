...
# with open(dev_data_path, mode='r', encoding='utf-8') as fr:
...
#     json.dump(return_list, open(dev_data_hanlp_path, mode='a', encoding='utf-8'), ensure_ascii=False, indent=4)
# print(len(cixing_list))
# print(cixing_list)
